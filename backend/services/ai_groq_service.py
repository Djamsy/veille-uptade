...
def enrich_article_with_groq(article: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        try:
            from backend.services.entity_aliases import resolve_entities
...
def split_radio_transcription(
    ...
    try:
        from backend.services.entity_aliases import correct_text_stt
    except ImportError:
        try:
    ...
    try:
        ...
        try:
            from backend.services.entity_aliases import resolve_entities, correct_entities_list, correct_text_stt as _correct_stt
        except ImportError:
            try:
...
def smart_enrich_article(article: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if groq_result is not None:
        ...
        try:
            from backend.services.tags_index import detect_entities, detect_theme
...
def generate_affair_context(
    ...
    try:
        ...
        try:
            from backend.services.entity_aliases import correct_text_stt as _fix, correct_entities_list as _fix_ents
        except ImportError:
            try:
