...
# ============================================================
from backend.services.entity_aliases import ELECTED_ALIASES, _normalize

try:
    from backend.services.elus_database import get_mandat_commune  # type: ignore
...
from backend.services.ai_groq_service import _call_ai, is_available as ai_is_available
