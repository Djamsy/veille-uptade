...
# Import des services
try:
    from backend.services.enhanced_scraper import create_enhanced_scraper
    from backend.services.sentiment_analysis_service import SentimentAnalysisService
    from backend.services.media_noise_service import MediaNoiseService
except ImportError:
...
async def telegram_morning_digest_job():
    ...
    try:
        ...
        from backend.services.telegram_alerts_service import TelegramAlertsService
        from backend.services.ai_groq_service import _call_ai, is_available as ai_available
