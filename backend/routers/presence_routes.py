...
from backend.services.entity_aliases import ELECTED_ALIASES

from backend.services.entity_presence_service import extract_presences_from_article, aggregate_by_commune, aggregate_by_entity, GUADELOUPE_COMMUNES
