...
Usage :
    ...
    python -m backend.scripts.reconcile_existing_data --dry-run

    # Mode live (écrit en base)
    python -m backend.scripts.reconcile_existing_data

    # Personnaliser la fenêtre temporelle
    python -m backend.scripts.reconcile_existing_data --days 7

    # Réconcilier aussi les affaires
    python -m backend.scripts.reconcile_existing_data --days 7 --affairs
"""
...
def main():
    ...
    from backend.services.entity_reconciliation_service import EntityReconciliationService
