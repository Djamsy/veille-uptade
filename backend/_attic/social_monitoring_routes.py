...
try:
    from backend._attic.intelligent_social_monitor import intelligent_social_monitor
    from backend._attic.sentiment_metrics_dashboard import sentiment_dashboard
except ImportError:
    try:
