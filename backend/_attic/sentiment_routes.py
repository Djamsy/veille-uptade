...
try:
    from backend.services.sentiment_analysis_service import analyze_text_sentiment as local_analyze_sentiment
except Exception:
    try:
...
try:
    from backend.services.sentiment_analysis_service import predict_population_reaction as local_predict_population_reaction
except Exception:
    try:
...
try:
    from backend._attic.gpt_sentiment_service import predict_population_reaction as gpt_predict_population_reaction
except Exception:
    try:
