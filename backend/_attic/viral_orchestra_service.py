...
try:
    from backend._attic.viral_detection_service import viral_detector
    from backend._attic.social_amplification_tracker import social_amplification
    from backend._attic.viral_escalation_predictor import escalation_predictor
    from backend.services.media_noise_service import media_noise_service
    from backend._attic.gpt_sentiment_service import gpt_sentiment_analyzer
    from backend.services.telegram_alerts_service import telegram_alerts
    from backend._attic.population_reaction_service import PopulationReactionPredictor
