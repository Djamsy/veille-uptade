    ...
    def __init__(self):
        ...
        self.streams = {
            ...
            "gp_tv_0615": {
                ...
                "section": "6H15 GP",
                "description": "Guadeloupe 1ère TV — Journal matinal",
                "type": "tv",
            ...
            "gp_tv_1900": {
                ...
                "section": "19H GP",
                "description": "Guadeloupe 1ère TV — Journal du soir",
                "type": "tv",
                "url": "https://guadeloupe.francetvinfo.fr/guadeloupe/emissions/jt-local-1819/",
                "duration_minutes": 25,
                "schedule": {"days": ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], "hour": 19, "minute": 0},
            ...
            "rci_replay": {
                "name": "RCI Guadeloupe Replay",
                "section": "RCI Replay",
                "description": "RCI Guadeloupe — Flux replay",
                "type": "radio",
                "url": "https://rci.streamakaci.com/rci971.mp3",
                "duration_minutes": 15,
                "schedule": {"days": "daily", "hour": 8, "minute": 0},
                "priority": 8,
                "enabled": True,
            },
            "rci_7h": {
                "name": "RCI Guadeloupe 7h",
                "section": "RCI 7H",
                "description": "RCI Guadeloupe — Journal 7h",
                "type": "radio",
                "url": "https://rci.streamakaci.com/rci971.mp3",
                "duration_minutes": 30,
            ...
            "guadeloupe_premiere_7h": {
                ...
                "section": "GP Radio 7H",
                "description": "Guadeloupe 1ère Radio — Journal 7h",
                "type": "radio",
