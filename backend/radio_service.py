...
class RadioTranscriptionService:
    ...
    def __init__(self):
        ...
        self.streams = {
            ...
            # GP TV désactivés — l'URL francetvinfo.fr est une page web, pas un flux audio
            # FFmpeg ne peut pas capturer depuis une page HTML
            "gp_tv_0615": {
                "name": "GP TV Journal 6h15",
                "section": "6H15 GP",
                "description": "Guadeloupe 1ère TV — Journal matinal (désactivé: pas de flux audio)",
                "type": "tv",
                "url": "https://guadeloupe.francetvinfo.fr/guadeloupe/emissions/jt-local-1819/",
                "duration_minutes": 20,
            ...
            "gp_tv_1900": {
                "name": "GP TV Journal 19h00",
                "section": "19H GP",
                "description": "Guadeloupe 1ère TV — Journal du soir (désactivé: pas de flux audio)",
                "type": "tv",
                "url": "https://guadeloupe.francetvinfo.fr/guadeloupe/emissions/jt-local-1819/",
                "duration_minutes": 25,
                "schedule": {"days": ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], "hour": 19, "minute": 0},
            ...
            # rci_replay et rci_7h supprimés — doublons de rci_0700/rci_0730
            # guadeloupe_premiere_7h désactivé — doublon de gp_radio_0700 au même créneau
            # URL HLS akamaized moins fiable que le flux MP3 Infomaniak
            "guadeloupe_premiere_7h": {
                "name": "Guadeloupe 1ère Radio 7h",
                "section": "GP Radio 7H",
                "description": "Guadeloupe 1ère Radio — Journal 7h (désactivé: doublon gp_radio_0700)",
                "type": "radio",
                "url": "https://live03-guadeloupe.akamaized.net/hls/live/2038433/GI3rfz2-KTLPnA",
                "duration_minutes": 24,
                "schedule": {"days": ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], "hour": 7, "minute": 0},
                "priority": 9,
                "enabled": False,
